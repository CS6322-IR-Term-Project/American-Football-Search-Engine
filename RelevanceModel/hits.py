...
hub_score_file = open("hubs_score_1", 'w')
authority_score_file = open("authority_score_1", 'w')
...
def get_webgraph_inlinks():
    inlinks_file = open("../../../../../../Downloads/apache-nutch-1.19/tmp_out/part-r-00000", 'r').readlines()
...
if __name__=="__main__":
    # after running
    # bin/nutch nodedumper -webgraphdb crawl/webgraphdb -inlinks -outlinks -output dump
